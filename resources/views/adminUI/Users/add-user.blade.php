...
<div class="container">
    ...
    <form method="POST" action="{{ route('users.save') }}" enctype="multipart/form-data">
        ...
        <div class="section">
          <h2 style="margin-block-end: 25px; font-size: 24px;margin-block-start: 6px;color: #1f7a5b;">Personal Details</h2>
        ...
        <div class="details-container">
          ...
          <div class="section">
            ...
            <div class="input-group">
              ...
              <input type="text" name="phone_number" placeholder="Add Phone Number">
            </div>
            <div class="input-group">
              <label>Email</label>
