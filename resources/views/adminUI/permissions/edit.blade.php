...
<div class="container mt-5">
    ...
    <div class="d-flex justify-content-end align-items-center" style="margin-block-end: 20px; position: relative;">
        <!-- Back Button -->
...
<style>
    ...
    max-inline-size: 90%; /* جعلها تمتد إلى نسبة كبيرة من الشاشة */
    inline-size: 1800px;/* تعيين عرض ثابت كبير */
    margin: 0 auto;
}
