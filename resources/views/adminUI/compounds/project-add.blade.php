        ...
        <div class="upload-section">
            ...
            <div class="extra-fields">
                <div class="form-group">
                    ...
                    <input type="text" id="field1" name="property_name" placeholder="Add compound Name">
                    @error('name')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group">
                    <label for="field2">Developer name</label>
                ...
                <div class="form-group" style="grid-column: span 2;">
                    ...
                    <input type="text"  name="location" required id="field3" placeholder="Enter location">
                    @error('location')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                   @enderror
                </div>
          ...
          <div class="section1">
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="Installment Options" id="No" placeholder="Installment Options">
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" placeholder="Enter a description for the unit"></textarea>
                    @error('description')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <textarea id="description" placeholder=" about compound"></textarea>
                    @error('about')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
        ...
        <div class="form-section">
            <div class="section1">
                <div class="form-row">
                    ...
                    <textarea id="description" placeholder=" facilities"></textarea>
                    @error('facilities')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                    </div>
                    ...
                    <textarea id="description" placeholder=" services"></textarea>
                    @error('services')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                    </div>
